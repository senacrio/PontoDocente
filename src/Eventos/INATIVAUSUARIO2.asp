...
<% response.buffer = true 
   ...
   wSigla="ACM"
   wHora= CSTR(Time)
   USUARIO=trim(CStr(Request.QueryString("SIGLA")))

WSQL="UPDATE USUARIO SET STATUS='I' WHERE IDSIGLA = '" + USUARIO + "'"
...
<table width="800" height="69" border="0" align="center" class="BordasLaterais">
  <tr>
    <td height="57" bgcolor="#FFFFFF"><div align="center"><strong>	<font color="#0033CC" size="4">
  	***  USU&Aacute;RIO INATIVADO ***</font></strong></div></td>
</table>

<p align="center">&nbsp;</p>
<p align="center">&nbsp;</p>
<p align="center"><a href="INATIVAUSUARIO.asp"><img src="images/seta03.gif" width="33" height="33" border="0"></a></p>
</html>
