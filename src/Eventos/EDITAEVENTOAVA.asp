...
Eventos.Source = "SELECT * FROM EVENTOCONDENSADO WHERE IDSTATUS=3"
...
<div align="center"><img src="images/BANNER1.gif" width="800" height="70"><br>
  ...
  <tr>
    <td width="36" align="default" nowrap bgcolor="#FFFFFF"><font color="#3366CC" size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp; </font></td>
    <td width="514" align="default" nowrap bgcolor="#FFFFFF"><div align="center"><font color="#3366CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"> NOME
    EVENTO </font></div></td>
    <td width="238" align="default" nowrap bgcolor="#FFFFFF"><div align="center"><font color="#3366CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"> DATA </font></div></td>
    </tr>
  <% 
While ((Repeat1__numRows <> 0) AND (NOT Eventos.EOF)) 
%>
  <tr bgcolor="#FFFFFF">
    <td width="36" height="14" align="default" nowrap> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="EditaEvento2AVA.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDEVENTO=" & Eventos.Fields.Item("IDEVENTO").Value %>"> <img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></a></font></div></td>
    <td width="514" align="default" nowrap> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("NOMEEVENTO").Value)%> </font></div></td>
    <td width="238" align="default" nowrap> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">	<% IF Eventos.Fields.Item("DATA").Value="" then%>	
