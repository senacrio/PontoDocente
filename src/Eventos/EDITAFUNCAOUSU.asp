...
response.Expires = 0
WSIGLA=trim(CStr(Request.QueryString("SIGLA")))
...
<body background="images/FUNDOGS.GIF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    ...
    <form id="myform" action="GRAVAINCFUNCAO.ASP" method="post"">  
    <table width="800" height="40" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" class="BordasLaterais">
  <td align="default" nowrap><div align="center"><strong><font color="#003399" size="1" face="Verdana, Arial, Helvetica, sans-serif">PERMISS&Atilde;O</font></strong></div>
    </td>
  </tr>
  <% 
...
%>
  <tr>
    <td height="20" align="default" nowrap bgcolor="#FFFFFF">
    ...
    <td width="664" align="default" nowrap bgcolor="#FFFFFF">
      <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("DESCFUNCAO").Value)%> </font></div>
    </td>
...
%>
    ...
    <td width="37" height="19" align="default" nowrap><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"> ID</font></td>
      ...
      <div align="center"><br>
       <input name="SIGLA" type="hidden" value="<%=WSIGLA%>">
