...
Eventos.Source = "SELECT * FROM UNIDADERESP WHERE STATUS='A'"
...
<div align="center"><img src="images/BANNER1.gif" border="0" align="middle"><br>
  ...
  <tr>
    <td width="23" align="default" nowrap bordercolor="#FFFFFF"><strong><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"> ID</font></strong></td>
    <td width="764" align="default" nowrap><strong><font color="#666699" size="1" face="Verdana, Arial, Helvetica, sans-serif"> NOME
        DO UNIDADE</font></strong></td>
    </tr>
  <% 
While ((Repeat1__numRows <> 0) AND (NOT Eventos.EOF)) 
%>
  <tr>
    <td width="23" height="21" align="default" nowrap bgcolor="#FFFFFF"> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="EditaUNIDADE2.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDUNIDADE=" & Eventos.Fields.Item("IDUNIDADE").Value %>"> <img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></A></font></div></td>
    <td width="764" align="default" nowrap bgcolor="#FFFFFF"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("NOMEUNIDADE").Value)%> </font></div></td>
  </tr>
  <% 
