...
<input type="text" name="OutrosObjetivo" value="<%=ObjetivoOu%>" onBlur="OO();" size="40" maxlength="200" tabindex="22" style="position:absolute;z-index:2006;left:255px;top:50px;width:331px;height:20px;font-size:8pt;font-family:Arial;font-weight:normal;font-style:normal;color:#000000;background-color:#FFFFFF;">
  
<div id="WFDObj115" style="position:absolute;z-index:2006;left:207px;top:48px;width:37px;height:14px;font-size:8pt;font-family:Arial;font-weight:normal;font-style:normal;text-align:left;color:#000000;"> 
  Outros</div>
