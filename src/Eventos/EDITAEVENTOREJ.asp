...
Eventos.Source = "SELECT * FROM EVENTOCONDENSADO WHERE IDSTATUS=4"
...
<table width="800" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" class="BordasLaterais">
  <tr>
    <td width="27" align="default" nowrap><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"> ID</font></td>
    <td width="450" align="default" nowrap><div align="left"><strong><font color="#0033CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"> NOME EVENTO </font></strong></div></td>
    <td width="311" align="default" nowrap><strong><font color="#0033CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"> DATA </font></strong></td>
  </tr>
  <% 
While ((Repeat1__numRows <> 0) AND (NOT Eventos.EOF)) 
%>
  <tr>
    <td width="27" height="22" align="default" nowrap bgcolor="#FFFFFF"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
      <div align="center"><a href="EditaEvento1REJ.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDEVENTO=" & Eventos.Fields.Item("IDEVENTO").Value %>"><img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></a></div>
    </div></td>
    <td width="450" align="default" nowrap bgcolor="#FFFFFF"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("NOMEEVENTO").Value)%> </font></div></td>
    <td width="311" align="default" nowrap bgcolor="#FFFFFF"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">	<% IF Eventos.Fields.Item("DATA").Value="" then%>	
