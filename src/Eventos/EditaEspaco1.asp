      ...
      Without Javascript enabled, this form will not function correctly</strong>
        ...
        <div id="WFDForm" style="position:relative;left:-1px;top:-20px;width:600px;height:1960px;background-color:#FFFFFF;">
          <form name="CadEventos" action="EDITAGRAVAEVENTO.asp" method="POST" enctype="application/x-www-form-urlencoded" onSubmit="return CadEventos_CF();">
            ...
            <input type="submit" name="Enviar" value="Enviar" tabindex="4" style="position:absolute;z-index:71;left:514px;top:1948px;width:78px;height:31px;font-size:12pt;font-family:Arial;font-weight:normal;font-style:normal;color:#FFFFFF;background-color:#0000FF;border-style:inset;">
            <div id="Layer1" style="position:absolute; width:589px; height:165px; background-color:#FFFFFF; layer-background-color:#FFFFFF; border:1px none #000000; z-index:1; left: 5px; top: 1779px;">
			...
			<div id="WFDObj113" style="position:absolute; z-index:113; left:-43px; top:4px; width:34px; height:248px; font-size:12pt; font-family:Verdana; font-weight:bold; font-style:normal; text-align:center; color:#E80000; background-color: #FF6600; layer-background-color: #FF6600; border: 1px none #000000;"> 
