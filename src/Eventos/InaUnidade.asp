...
%>
  <tr>
    <td width="23" height="21" align="default" nowrap bgcolor="#FFFFFF"> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="INAUNIDADE2.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDUNIDADE=" & Eventos.Fields.Item("IDUNIDADE").Value %>"> <img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></A></font></div></td>
