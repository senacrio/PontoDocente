...
<div align="center"><img src="images/BANNER1.gif" border="0" align="middle"><br>
    ...
    <table width="800" height="41" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" class="BordasLaterais">
  <tr>
    <td width="32" height="18" align="default" nowrap><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"> ID</font></td>
    <td width="437" align="default" nowrap><div align="center"><strong><font color="#003399" size="1" face="Verdana, Arial, Helvetica, sans-serif"> NOME EVENTO </font></strong></div></td>
    <td width="319" align="default" nowrap><div align="center"><strong><font color="#003399" size="1" face="Verdana, Arial, Helvetica, sans-serif"> DATA </font></strong></div></td>
    </tr>
  <% 
While ((Repeat1__numRows <> 0) AND (NOT Eventos.EOF)) 
%>
  <tr>
    <td width="32" height="19" align="default" nowrap bgcolor="#FFFFFF"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="GravaEspacoINA.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDESPACO=" & Eventos.Fields.Item("IDESPACO").Value %>"><img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></a> </font></div></td>
    <td width="437" align="default" nowrap bgcolor="#FFFFFF"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("NOMEEVENTO").Value)%> </font></div></td>
    <td width="319" align="default" nowrap bgcolor="#FFFFFF"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("DATA").Value)%> </font></div></td>
  </tr>
  <% 
