...
<div align="center"><img src="images/BANNER1.gif" width="800" height="70"><br>
    ...
    <table width="800" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" background="images/FUNDOGS.GIF" class="BordasLaterais">
  <tr>
    <td width="39" align="default" nowrap><strong><font color="#6666CC" size="2" face="Arial, Helvetica, sans-serif"></font></strong></td>
    <td width="519" align="default" nowrap><div align="center"><strong><font color="#6666CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"> NOME EVENTO </font></strong></div></td>
    <td width="230" align="default" nowrap><div align="center"><strong><font color="#6666CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"> DATA </font></strong></div></td>
    </tr>
  <% 
While ((Repeat1__numRows <> 0) AND (NOT Eventos.EOF)) 
%>
  <tr class="BordasLaterais">
    <td width="39" height="27" align="default" nowrap bgcolor="#FFFFFF" > <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="EditaEvento1AVA.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDEVENTO=" & Eventos.Fields.Item("IDEVENTO").Value %>"> <img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></a></font></div></td>
    <td width="519" align="default" nowrap bgcolor="#FFFFFF" > <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("NOMEEVENTO").Value)%> </font></div></td>
    <td width="230" align="default" nowrap bgcolor="#FFFFFF" > <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">	<% IF Eventos.Fields.Item("DATA").Value="" then%>	
	  <%=Eventos.Fields.Item("DIA").Value%>/
	  <%=Eventos.Fields.Item("MES").Value%>/
 	  <%=Eventos.Fields.Item("ANO").Value%>
	<%else%>
