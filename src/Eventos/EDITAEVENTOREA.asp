...
Eventos.Source = "SELECT * FROM EVENTOCONDENSADO WHERE IDSTATUS=6"
...
<div align="center"><img src="images/BANNER1.gif" border="0" align="middle"><br>
  ...
  <tr>
    <td width="39" align="default" nowrap><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"> ID</font></td>
    <td width="521" align="default" nowrap><div align="center"><strong><font color="#663399" size="1" face="Verdana, Arial, Helvetica, sans-serif"> NOME EVENTO </font></strong></div></td>
    <td width="228" align="default" nowrap><div align="center"><strong><font color="#663399" size="1" face="Verdana, Arial, Helvetica, sans-serif"> DATA </font></strong></div></td>
    </tr>
  <% 
While ((Repeat1__numRows <> 0) AND (NOT Eventos.EOF)) 
%>
  <tr>
    <td width="39" height="19" align="default" nowrap bgcolor="#FFFFFF"> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> <a href="EditaGravaEventoREA.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDEVENTO=" & Eventos.Fields.Item("IDEVENTO").Value %>"><img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></A></font></div></td>
    <td width="521" align="default" nowrap bgcolor="#FFFFFF"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("NOMEEVENTO").Value)%> </font></div></td>
    <td width="228" align="default" nowrap bgcolor="#FFFFFF"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("DATA").Value)%> </font></div></td>
  </tr>
  <% 
