...
response.Expires = 0
IdSIGLA=Request.QueryString("IdSIGLA")
RESPONSE.WRITE(IDSIGLA)
RESPONSE.END
...
Eventos.Source = "SELECT * FROM USUARIO"
...
<body background="images/FUNDOGS.GIF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  ...
  <tr>
    <td width="28" align="default" nowrap><font color="#3366CC" size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font></td>
    <td width="753" align="default" nowrap><font color="#3366CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"> NOME
        DO USUARIO</font></td>
    </tr>
  <% 
...
%>
  <tr bgcolor="#FFFFFF">
    <td width="28" height="21" align="default" nowrap> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="EditaUSUARIO2.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDSIGLA=" & Eventos.Fields.Item("IDSIGLA").Value %>"> <img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></a></font></div></td>
    <td width="753" align="default" nowrap> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("NOMEUSUARIO").Value)%> </font></div></td>
  </tr>
  <% 
