...
Unidade.Source = "SELECT IDUNIDADE, NOMEUNIDADE FROM UNIDADERESP"
...
<table width="758" height="2033" border=0 align="center" bgcolor="#FFFFFF">
...
return true;
      ...
      Without Javascript enabled, this form will not function correctly</strong>
        ...
        <div id="WFDForm" style="position:relative;left:-1px;top:-20px;width:600px;height:1960px;background-color:#FFFFFF;">
          <form name="CadEventos" action="EDITAGRAVAEVENTO.asp" method="POST" enctype="application/x-www-form-urlencoded" onSubmit="return CadEventos_CF();">
            <div id="PARCEIRO" style="position:absolute;z-index:2005;left:5px;top:1722px;width:590px;height:53px;background:#FFFFFF;"> 
              <!--#include file="INCPARCEIRO.ASP" --></div>
            <div id="RECEITA" style="position:absolute;z-index:2005;left:6px;top:1674px;width:588px;height:32px;background:#FFFFFF">
              <!--#include file="INCRECEITA.ASP" -->
            </div>
            
            <div id="WFDObj7" style="position:absolute;z-index:7;left:7px;top:1627px;width:588px;height:32px;background:#FFFFFF">
              <!--#include file="INCCUSTOORC.ASP" --></div>
            <div id="WFDObj8" style="position:absolute;z-index:8;left:7px;top:1618px;width:214px;height:12px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:center;color:#000000;"> 
            ...
            <div id="WFDObj11" style="position:absolute;z-index:11;left:6px;top:1403px;width:590px;height:53px;background:#FFFFFF;">
              <!--#include file="INCMATERIAL.ASP" -->
            </div>
            <div id="WFDObj12" style="position:absolute;z-index:12;left:7px;top:1392px;width:541px;height:14px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:center;color:#000000;">
            ...
            <div id="WFDObj15" style="position:absolute;z-index:15;left:6px;top:1267px;width:225px;height:12px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:center;color:#000000;">
              <div align="left"><strong><font size="1" face="Times New Roman, Times, serif">5.1 QUAL O PLANO DE DIVULGAÇÃO?</font></strong></div>
            </div>
            <div id="WFDObj14" style="position:absolute;z-index:14;left:7px;top:1279px;width:590px;height:109px;background:#FFFFFF">
              <!--#include file="INCDIVULG.ASP" -->
            </div>
            <div id="WFDObj26" style="position:absolute;z-index:26;left:6px;top:1039px;width:236px;height:11px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:center;color:#000000;">
              <div align="left"><font size="1" face="Times New Roman, Times, serif"><strong>4.3
              HAVERÁ OUTRAS PARTICIPAÇÕES?</strong></font></div>
            </div>
            <div id="WFDObj27" style="position:absolute;z-index:27;left:6px;top:1051px;width:588px;height:79px;background:#FFFFFF">
            ...
            <div id="WFDObj68" style="position:absolute;z-index:68;left:6px;top:4px;width:590px;height:178px;background:#FFFFFF;"> 
              <!--#include file="INCheader.ASP" --></div>
            <input type="submit" name="Enviar" value="Enviar" tabindex="4" style="position:absolute;z-index:71;left:514px;top:1948px;width:78px;height:31px;font-size:12pt;font-family:Arial;font-weight:normal;font-style:normal;color:#FFFFFF;background-color:#FF9C6C;border-style:inset;">
            <div id="Layer1" style="position:absolute; width:589px; height:165px; background-color:#99CCFF; layer-background-color:#99CCFF; border:1px none #000000; z-index:1; left: 5px; top: 1779px;">
              <!--#include file="INCSUPL.ASP" --></div>
            <div id="WFDObj85" style="position:absolute;z-index:85;left:6px;top:423px;width:169px;height:12px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:center;color:#000000;">
              <div align="left"><font size="1" face="Times New Roman, Times, serif"><strong>2. ÁREA
              DE CONHECIMENTO</strong></font></div>
            </div>
            <div id="WFDObj5" style="position:absolute;z-index:5;left:6px;top:436px;width:588px;height:128px;background:#FFFFFF">
              <!--#include file="INCAREAC.ASP" -->
            </div>
            <div id="WFDObj113" style="position:absolute; z-index:113; left:-43px; top:4px; width:39px; height:248px; font-size:12pt; font-family:Verdana; font-weight:bold; font-style:normal; text-align:center; color:#E80000; background-color: #99CCFF; layer-background-color: #99CCFF; border: 1px none #000000;"> 
			
			
			
			  <div align="center"><font color="#FFFFFF">		          <font size="2" face="Arial, Helvetica, sans-serif"><font color="#0066FF" size="3" face="Arial, Helvetica, sans-serif"><strong><br>
            ...
            <div id="WFDObj146" style="position:absolute;z-index:146;left:7px;top:294px;width:283px;height:13px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:center;color:#000000;">
              <div align="left"><strong><font size="1" face="Times New Roman, Times, serif">1.1
              OBJETIVO DA PARTICIPAÇÃO SENAC RIO:</font></strong></div>
            </div>
            <div id="WFDObj70" style="position:absolute;z-index:70;left:7px;top:306px;width:588px;height:108px;background:#FFFFFF;">
              <!--#include file="INCOBJ1.ASP" -->
            </div>
            <div id="WFDObj170" style="position:absolute;z-index:170;left:7px;top:572px;width:350px;height:13px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:center;color:#000000;">
            ...
            <div id="WFDObj156" style="position:absolute;z-index:156;left:6px;top:584px;width:589px;height:86px;background:#FFFFFF;">
            ...
            <div id="WFDObj187" style="position:absolute;z-index:187;left:6px;top:859px;width:268px;height:13px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:center;color:#000000;">
              <div align="left"><strong><font size="1" face="Times New Roman, Times, serif">4.1 QUAL O PÚLICO? - ALVO PESSOA FÍSICA</font></strong></div>
            </div>
            <div id="WFDObj52" style="position:absolute;z-index:52;left:6px;top:870px;width:588px;height:77px;background:#FFFFFF">
              <!--#include file="INCPF.ASP" -->
            </div>
            <div id="WFDObj191" style="position:absolute;z-index:191;left:6px;top:1147px;width:588px;height:53px;background:#FFFFFF"> 
              <!--#include file="INCPUB.ASP" --></div>
            <div id="WFDObj193" style="position:absolute;z-index:193;left:7px;top:1136px;width:231px;height:13px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:center;color:#000040;">
              <div align="left"><strong><font size="1" face="Times New Roman, Times, serif">4.4
              QUAL A ESTIMATIVA DE PÚBLICO?</font></strong></div>
            </div>
            <div id="WFDObj194" style="position:absolute;z-index:194;left:6px;top:1216px;width:588px;height:46px;background:#FFFFFF;">
              <!--#include file="INCREACAO.ASP" -->
            </div>
            <div id="WFDObj211" style="position:absolute;z-index:211;left:5px;top:1473px;width:588px;height:60px;background:#FFFFFF">
              <!--#include file="INCFOTO.ASP" --></div>
        
          <div id="WFDObj213" style="position:absolute;z-index:213;left:6px;top:1462px;width:315px;height:13px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:center;color:#000000;">
          ...
          <div id="WFDObj219" style="position:absolute;z-index:219;left:6px;top:1539px;width:478px;height:13px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:center;color:#000000;"> 
          ...
          <div id="WFDObj220" style="position:absolute;z-index:220;left:6px;top:1551px;width:588px;height:20px;background:#FFFFFF;">
<!--#include file="INCLANCORC.ASP" -->
</div>
          <div id="WFDObj225" style="position:absolute;z-index:225;left:7px;top:1576px;width:473px;height:12px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:center;color:#000040;"> 
		  ...
		  <div id="WFDObj4" style="position:absolute;z-index:4;left:6px;top:1587px;width:588px;height:23px;background:#FFFFFF">
         <!--#include file="INCINVEST.ASP" -->
		 </DIV>
          <div id="WFDObj232" style="position:absolute;z-index:232;left:7px;top:1664px;width:190px;height:12px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:center;color:#000040;"> 
            <div align="left"><font size="1" face="Times New Roman, Times, serif"><strong>6.4
              RECEITA TOTAL PREVISTA?</strong></font></div>
          </div>
          <div id="WFDObj234" style="position:absolute;z-index:234;left:6px;top:1710px;width:410px;height:12px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:center;color:#000000;"> 
          ...
          <div id="WFDObj235" style="position:absolute;z-index:235;left:6px;top:187px;width:136px;height:17px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:left;color:#000000;"> <strong><font size="1" face="Times New Roman, Times, serif">1.
            O QUE É O EVENTO?</font></strong></div>
          <div id="WFDObj69" style="position:absolute;z-index:69;left:6px;top:198px;width:588px;height:91px;background:#FFFFFF">
            <!--#include file="INCTIPO1.ASP" -->
          </div>
          <div id="WFDObj236" style="position:absolute;z-index:236;left:6px;top:951px;width:282px;height:12px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:left;color:#000000;"> <font size="1" face="Times New Roman, Times, serif"><strong>4.2
            QUAL O PÚBLICO - ALVO PESSOA JURÍDICA</strong></font></div>
          <div id="WFDObj40" style="position:absolute;z-index:40;left:6px;top:963px;width:588px;height:73px;background:#FFFFFF">
            <!--#include file="INCPJ.ASP" -->
          </div>
          <div id="WFDObj237" style="position:absolute;z-index:237;left:5px;top:1205px;width:394px;height:12px;font-size:8pt;font-family:Verdana;font-weight:normal;font-style:normal;text-align:center;color:#D90000;">
            <div align="left"><strong><font color="#000000" size="1" face="Times New Roman, Times, serif">4.5 SERÁ FEITA A AVALIAÇÃO DE REAÇÃO
              (cadastro de vsitantes?)</font></strong></div>
          </div>
...
Set EventoS = Nothing
%>
  <a href="MENUEL.ASP"><img src="images/seta03.gif" width="33" height="33" border="0"></a>
  <div id="Layer3" style="position:absolute; width:17px; height:17px; background-color:#FFFFFF; layer-background-color:#FFFFFF; border:1px none #000000; z-index:2; left: 827px; top: 94px;"><a href="ImprimeEvento.asp?idevento=<%=idevento%>"><img src="images/PRINTERS.ICO" border="0"></a> </div>
</div>
