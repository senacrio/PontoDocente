...
Eventos.Source = "SELECT * FROM CATEGORIA WHERE STATUS='I'"
...
<div align="center"><img src="images/BANNER1.gif" border="0" align="middle"><br>
  ...
  <tr>
    ...
    <td width="753" align="default" nowrap><font color="#3366CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"> NOME
        DO CATEGORIA</font></td>
    </tr>
  <% 
While ((Repeat1__numRows <> 0) AND (NOT Eventos.EOF)) 
%>
  <tr bgcolor="#FFFFFF">
    <td width="28" height="21" align="default" nowrap> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="REACATEGORIA2.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDCATEGORIA=" & Eventos.Fields.Item("IDCATEGORIA").Value %>"> <img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></a></font></div></td>
    <td width="753" align="default" nowrap> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("DESCCATEGORIA").Value)%> </font></div></td>
  </tr>
  <% 
