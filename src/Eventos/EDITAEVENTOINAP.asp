...
<div align="center"><img src="images/BANNER1.gif" border="0" align="middle"><br>
  ...
  <tr>
    <td width="30" align="default" nowrap><font color="#666699" size="2" face="Verdana, Arial, Helvetica, sans-serif"> ID</font></td>
    <td width="504" align="default" nowrap><div align="center"><font color="#666699" size="1" face="Verdana, Arial, Helvetica, sans-serif"> NOME EVENTO </font></div></td>
    <td width="242" align="default" nowrap><font color="#666699" size="1" face="Verdana, Arial, Helvetica, sans-serif"> DATA </font></td>
    </tr>
  <% 
While ((Repeat1__numRows <> 0) AND (NOT Eventos.EOF)) 
%>
  <tr bgcolor="#FFFFFF">
    <td width="30" height="14" align="default" nowrap> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="EditaGravaEventoINAP.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDEVENTO=" & Eventos.Fields.Item("IDEVENTO").Value %>"><img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></a></font></div></td>
    <td width="504" align="default" nowrap> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("NOMEEVENTO").Value)%> </font></div></td>
    <td width="242" align="default" nowrap> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("DATA").Value)%> </font></div></td>
  </tr>
  <% 
