...
Eventos.Source = "SELECT * FROM local"
...
<div align="center"><img src="images/BANNER1.gif" border="0" align="middle"><br>
    ...
    <table width="800" border="1" align="center" cellpadding="1" cellspacing="0" bordercolor="#FFFFFF" class="BordasLaterais">
  <tr>
    <td width="27" align="default" nowrap><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"> ID</font></td>
    <td width="760" align="default" nowrap><div align="left"><strong><font color="#003399" size="1" face="Verdana, Arial, Helvetica, sans-serif"> NOME
        DO LOCAL</font></strong></div></td>
    </tr>
  <% 
While ((Repeat1__numRows <> 0) AND (NOT Eventos.EOF)) 
%>
  <tr>
    <td width="27" height="14" align="default" nowrap bgcolor="#FFFFFF"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
      <div align="center"><a href="EditaLOCAL2.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDLOCAL=" & Eventos.Fields.Item("IDLOCAL").Value %>"> <img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></A></div>
    </div></td>
    <td width="760" align="default" nowrap bgcolor="#FFFFFF"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("NOMELOCAL").Value)%> </font></div></td>
  </tr>
  <% 
