...
<form name="form1" method="post" action="calendario.asp">
  ...
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="BordasLaterais">
    <tr>
      <td colspan="6" bgcolor="#0099FF"><div align="center"><font color="#FFFFFF" size="2" face="Times New Roman, Times, serif"><strong>CALEND&Aacute;RIO DE EVENTOS SENAC RIO</strong></font></div></td>
    </tr>
    <tr>
      <td height="20">&nbsp;</td>
      <td>&nbsp;</td>
...
%>
 <option value="TODOS">TODOS</option>
      ...
      <td width="83"><label class="formfont">
      ...
      <td width="30" class="FormFont"><strong><font color="#0000FF">Excel:&nbsp;&nbsp;</font></strong></td>
...
<div align="center"><a href="MENUGE.ASP"><img src="images/seta03.gif" width="33" height="33" border="0"></a></div>
</body>
</html>
<%
Categoria.Close()
