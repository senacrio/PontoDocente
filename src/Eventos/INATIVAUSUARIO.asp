...
Eventos.Source = "SELECT * FROM USUARIO WHERE STATUS<>'I'"
...
%>
  <tr bgcolor="#FFFFFF">
    <td width="28" height="21" align="default" nowrap> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="INATIVAUSUARIO2.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "SIGLA=" & Eventos.Fields.Item("IDSIGLA").Value %>"> <img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></a></font></div></td>
    <td width="753" align="default" nowrap> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("IDSIGLA").Value)%> </font></div></td>
  </tr>
  <% 
