...
WSQL="UPDATE EVENTO SET NOMEEVENTO='" + wNomeEvento + "',DATA='" + wDataEvento + "',HORA='" + wHorario + "',IDLOCAL='" + wLocal + "',IDUNIDADE=" + wUnidade + ",IDSIGLA='" + wSigla + "',IDAREACON='" + wAreaCon + "',GVENDA="+ wGVenda + ",ENTRADA=" + wEntrada + ","
...
WSQL= WSQL + "IDDIVULGACAO='" + wDivulgacao + "',IDSTATUS=1,TIPOEVENTOOU='" + wTipoEventoOutro + "',ACAOQUAL='" + wAcaoQual + "',OBJETIVOOU='" + wOutrosObjetivo + "',"
WSQL= WSQL + "VENDA='" + wVenda + "',AVALIAQUAL='" + wAvaliaQual + "',VALORENTRADA='" + wValorEntrada + "',PFOUTRO='"+ wPFQual + "',PJOUTRO='" +wPJQual + "',POOUTRO='" + wOutraQual + "',DIVULGAQUAL='" + wDivulgacaoQual + "',ANO= " + WANO + ",MES=" + WMES + ",REALIZADOR='" + wRealizador + "',UPART='" + WUPART + "',OBS='" + WOBS + "',RESPONSAVEL='" + WRESPONSAVEL +  "',FECO=" + WFEC + ",DIA=" + WDIA 
...
<p align="center">&nbsp;</p>
<p>&nbsp;</p>
<table width="800" height="77" border="0" align="center" class="BordasLaterais">
  <tr>
    <td height="65" bgcolor="#FFFFFF"><div align="center"><strong>
	<font color="#0033CC" size="4">
 	***  EVENTO ALTERADO ***</font></strong></div></td>
  </tr>
</table>
...
<div align="center">
  ...
  <p>&nbsp;</p>
  <p><br>
    <a href="EDITAEVENTO.asp"><img src="images/seta03.gif" width="33" height="33" border="0"></a>
  </p>
</div>
<p align="center">&nbsp;</p>
</html>
