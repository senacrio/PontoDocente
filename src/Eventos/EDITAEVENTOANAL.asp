...
<div align="center"><img src="images/BANNER1.gif" border="0" align="middle"><br>
  ...
  <tr>
    <td width="32" align="default" nowrap><strong><font color="#003399" size="1" face="Verdana, Arial, Helvetica, sans-serif"> </font></strong></td>
    <td width="445" align="default" nowrap><div align="center"><strong><font color="#003399" size="1" face="Verdana, Arial, Helvetica, sans-serif"> NOME EVENTO </font></strong></div></td>
    <td width="305" align="default" nowrap><div align="center"><strong><font color="#003399" size="1" face="Verdana, Arial, Helvetica, sans-serif"> DATA </font></strong></div></td>
    </tr>
  <% 
While ((Repeat1__numRows <> 0) AND (NOT Eventos.EOF)) 
%>
  <tr>
    <td width="32" height="14" align="default" nowrap bgcolor="#FFFFFF" > <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="EditaEvento1ANA.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDEVENTO=" & Eventos.Fields.Item("IDEVENTO").Value %>"> <img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></a></font></div></td>
    <td width="445" align="default" nowrap bgcolor="#FFFFFF" > <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("NOMEEVENTO").Value)%> </font></div></td>
    <td width="305" align="default" nowrap bgcolor="#FFFFFF" > <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
