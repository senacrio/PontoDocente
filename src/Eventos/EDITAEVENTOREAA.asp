...
Eventos.Source = "SELECT * FROM EVENTOCONDENSADO WHERE IDSTATUS=7"
...
<body background="images/FUNDOGS.GIF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    ...
    <table width="800" border="1" align="center" cellpadding="0" cellspacing="1" bordercolor="#FFFFFF" class="BordasLaterais">
  <tr>
    <td width="39" align="default" nowrap><font color="#3366CC" size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font></td>
    <td width="521" align="default" nowrap><font color="#3366CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"> NOME EVENTO </font></td>
    <td width="228" align="default" nowrap><font color="#3366CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"> DATA </font></td>
    </tr>
  <% 
While ((Repeat1__numRows <> 0) AND (NOT Eventos.EOF)) 
%>
  <tr bgcolor="#FFFFFF">
    <td width="39" height="14" align="default" nowrap bgcolor="#FFFFFF"> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="EditaGravaEventoREAA.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDEVENTO=" & Eventos.Fields.Item("IDEVENTO").Value %>"> <img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></a></font></div></td>
    <td width="521" align="default" nowrap> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("NOMEEVENTO").Value)%> </font></div></td>
    <td width="228" align="default" nowrap> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("DATA").Value)%> </font></div></td>
  </tr>
  <% 
