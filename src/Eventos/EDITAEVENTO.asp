...
Eventos.Source = "SELECT * FROM EVENTOCONDENSADO WHERE IDSTATUS=1"
...
<table width="800" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" class="BordasLaterais">
      <tr>
        <td width="26" align="default" nowrap><div align="center"> </div></td>
        <td width="540" align="default" nowrap><div align="center"><strong><font color="#003399" size="1" face="Verdana, Arial, Helvetica, sans-serif"> NOME
            EVENTO </font></strong></div></td>
        <td width="220" align="default" nowrap><div align="center"><strong><font color="#003399" size="1" face="Verdana, Arial, Helvetica, sans-serif"> DATA </font></strong></div></td>
      </tr>
      <% 
While ((Repeat1__numRows <> 0) AND (NOT Eventos.EOF)) 
%>
      <tr>
        <td width="26" height="25" align="default" nowrap bgcolor="#FFFFFF">          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
        
            <div align="center"><a href="EditaEvento1C.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDEVENTO=" & Eventos.Fields.Item("IDEVENTO").Value %>"><font color="#3366FF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></FONT></a></div>
        </div>
        </td>
        <td width="540" align="default" nowrap bgcolor="#FFFFFF">
          <div align="left"><font color="#000066" size="1" face="Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("NOMEEVENTO").Value)%> </font></div>
        </td>
        <td width="220" align="default" nowrap bgcolor="#FFFFFF">
          <div align="left"><font color="#000066" size="1" face="Arial, Helvetica, sans-serif">
