...
<textarea name="AcaoQual" cols="40" onBlur="AC();" style="position:absolute;z-index:2006;left:67px;top:46px;width:515px;height:69px;font-size:8pt;font-family:Arial;font-weight:normal;font-style:normal;color:#000000;background-color:#FFFFFF;" tabindex="66"><%=AcaoQual%></textarea> 
