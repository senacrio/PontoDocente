...
Eventos.Source = "SELECT * FROM EMAIL"
...
<body background="images/FUNDOGS.GIF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  ...
  <tr>
    <td width="36" align="default" nowrap><div align="center"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"></font></div></td>
    <td width="751" align="default" nowrap><div align="center"><font color="#6633CC" size="1" face="Verdana, Arial, Helvetica, sans-serif">EMAIL</font></div></td>
    </tr>
  <% 
While ((Repeat1__numRows <> 0) AND (NOT Eventos.EOF)) 
%>
  <tr>
    <td width="36" height="21" align="default" nowrap bgcolor="#FFFFFF"> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="EditaEMAIL2.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDEMAIL=" & Eventos.Fields.Item("IDEMAIL").Value %>"> <img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></a></font></div></td>
    <td width="751" align="default" nowrap bgcolor="#FFFFFF"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("DESCEMAIL").Value)%> </font></div></td>
  </tr>
  <% 
