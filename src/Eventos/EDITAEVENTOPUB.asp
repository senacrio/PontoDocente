...
Eventos.Source = "SELECT * FROM EVENTOCONDENSADO WHERE IDSTATUS=2"
...
<div align="center"><img src="images/BANNER1.gif" border="0" align="middle"><br>
    ...
    <table width="800" height="5%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" class="BordasLaterais">
  <tr>
    <td width="36" height="55%" align="default" nowrap><strong><font color="#3366FF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><font color="#CCCCCC">D</font></font></strong></td>
    <td width="478" align="default" nowrap><strong><font color="#333399" size="1" face="Verdana, Arial, Helvetica, sans-serif"> NOME EVENTO </font></strong></td>
    <td width="274" align="default" nowrap><strong><font color="#333399" size="1" face="Verdana, Arial, Helvetica, sans-serif"> DATA</font></strong></td>
    </tr>
  <% 
While ((Repeat1__numRows <> 0) AND (NOT Eventos.EOF)) 
%>
  <tr>
    <td width="36" height="45%" align="default" nowrap bgcolor="#FFFFFF"> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="EditaEvento1PUB.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDEVENTO=" & Eventos.Fields.Item("IDEVENTO").Value %>"> <img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></a></font></div></td>
    <td width="478" align="default" nowrap bgcolor="#FFFFFF"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("NOMEEVENTO").Value)%> </font></div></td>
    <td width="274" align="default" nowrap bgcolor="#FFFFFF"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
	<%IF Eventos.Fields.Item("DATA").Value="" THEN%> 
	<%=(Eventos.Fields.Item("DIA").Value)%>/<%=(Eventos.Fields.Item("MES").Value)%>/<%=(Eventos.Fields.Item("ANO").Value)%>
 	<%ELSE%>
	    	<%=Eventos.Fields.Item("DATA").Value%>
	<%END IF%>
...
<br>
<table width="81%" border="0" align="center" cellspacing="1">
  <tr class="FormFont">
