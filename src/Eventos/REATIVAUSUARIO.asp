...
Eventos.Source = "SELECT * FROM USUARIO WHERE STATUS<>'A'"
...
%>
  <tr bgcolor="#FFFFFF">
    <td width="28" height="21" align="default" nowrap> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="REATIVAUSUARIO2.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "SIGLA=" & Eventos.Fields.Item("IDSIGLA").Value %>"> <img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></a></font></div></td>
