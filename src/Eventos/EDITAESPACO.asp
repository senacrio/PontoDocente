...
Eventos.Source = "SELECT * FROM ESPACO WHERE IDSTATUS=1"
...
%>
      <tr>
        <td width="26" height="25" align="default" nowrap bgcolor="#FFFFFF">          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
            ...
            <div align="center"><a href="EditaEspaco2.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDESPACO=" & Eventos.Fields.Item("IDESPACO").Value %>"><font color="#3366FF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></FONT></a></div>
        </div>
        </td>
        ...
        <td width="220" align="default" nowrap bgcolor="#FFFFFF">
          <div align="left"><font color="#000066" size="1" face="Arial, Helvetica, sans-serif"><%=(Eventos.Fields.Item("DATA").Value)%> </font></div>
        </td>
      </tr>
      <% 
...
<div align="center" class="FormFont">Registros <%=(Eventos_first)%> a <%=(Eventos_last)%> de <%=(Eventos_total)%>
  <br>
  <br>
  <a href="MENUCE.ASP"><img src="images/seta03.gif" width="33" height="33" border="0"></a></div>
</body>
</html>
<%
Eventos.Close()
