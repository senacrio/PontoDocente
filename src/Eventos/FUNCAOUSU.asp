...
<body background="images/FUNDOGS.GIF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    ...
    <form id="myform" action="GRAVAINCFUNCAO.ASP" method="post"">  <table width="800" height="41" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" class="BordasLaterais">
  <tr>
...
%>
  <tr>
    <td align="default" nowrap bgcolor="#FFFFFF"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
      <div align="center"><a href="EditaFUNCAO2.asp?<%= MM_keepBoth & MM_joinChar(MM_keepBoth) & "IDFUNCAO=" & Eventos.Fields.Item("CODFUNCAO").Value %>"> <img src="images/btnConfirmaBusca.gif" width="16" height="17" border="0"></A></div>
    </div></td>
    ...
    <td width="91" align="default" nowrap bgcolor="#FFFFFF">
      <div align="center">
        <label>
	    <%cf=Eventos.Fields.Item("CODFUNCAO").Value%>
	     <input type="Checkbox" name="funcao" value=<%=cf%>>
        </label>
      </div>
    </td>
  </tr>
