...
Partial Class clickoportunidades_admCBO
    ...
    Dim ArrayCargo As ArrayList = New ArrayList()
#Region " Funções "
...
#End Region
    ...
    Protected Sub btninserir0_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btninserir0.Click
        ...
        For i As Integer = 0 To ArrayCargo.Count - 1
            'Label6.Text += ArrayCargo(i).ToString + " "
            SqlrelacionaInserir.InsertParameters("id_cargo_fk").DefaultValue = ArrayCargo(i).ToString
    ...
    Protected Sub CheckBox2_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        ArrayCargo.Add(chk.ToolTip)
        'Label6.Text += chk.Text
    End Sub
