<%@ Page Language="VB" AutoEventWireup="false" CodeFile="admCBO2.aspx.vb" Inherits="clickoportunidades_admCBO" %>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:SqlDataSource ID="SqlCargos" runat="server" 
                                        ...
                                        SelectCommand="SELECT     id_cargo, cargo
FROM         tblCBO
WHERE     (tipo = 'Ocupação') AND (cargo LIKE + @cargo + '%') AND (cast(id_cargo as decimal ) &gt; 10000)
ORDER BY cargo">
                                        <SelectParameters>
                            ...
                            <tr>
                                <td class="style4" colspan="2">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <br />
                                            <asp:ListView ID="lstCargos" runat="server" DataKeyNames="id_cargo" 
                                                DataSourceID="SqlCargos" GroupItemCount="3">
                                                <EmptyItemTemplate>
                                                    <td runat="server" />
                                                    </EmptyItemTemplate>
                                                    <ItemTemplate>
                                                        <td runat="server" style="">
                                                            <asp:CheckBox ID="CheckBox2" runat="server" AutoPostBack="True" 
                                                                OnCheckedChanged="CheckBox2_CheckedChanged" Text='<%# Bind("cargo") %>' 
                                                                ToolTip='<%# Bind("id_cargo") %>' />
                                                            <br />
                                                        </td>
                                                    </ItemTemplate>
                                                    <AlternatingItemTemplate>
                                                        <td runat="server" style="">
                                                            <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" 
                                                                OnCheckedChanged="CheckBox1_CheckedChanged" Text='<%# Bind("cargo") %>' 
                                                                ToolTip='<%# Bind("id_cargo") %>' />
                                                            &nbsp;</td>
                                                    </AlternatingItemTemplate>
                                                    <EmptyDataTemplate>
                                                    ...
                                                    <InsertItemTemplate>
                                                        <td runat="server" style="">
                                                            id_cargo:
                                                            <asp:TextBox ID="id_cargoTextBox" runat="server" 
                                                                Text='<%# Bind("id_cargo") %>' />
                                                            <br />
                                                            cargo:
                                                                    ...
                                                                    <asp:DataPager ID="DataPager1" runat="server" PageSize="12">
                                                                        <Fields>
                                                                            <asp:NextPreviousPagerField ButtonType="Image" 
                                                                                FirstPageImageUrl="~/Icones/seta_esq.png" 
                                                                                NextPageImageUrl="~/Icones/seta_esq.png" ShowFirstPageButton="True" 
                                                                                ShowNextPageButton="False" ShowPreviousPageButton="False" />
                                                                            <asp:NumericPagerField />
                                                                            <asp:NextPreviousPagerField ButtonType="Image" 
                                                                                LastPageImageUrl="~/Icones/seta_direita.png" ShowLastPageButton="True" 
                                                                                ShowNextPageButton="False" ShowPreviousPageButton="False" />
                                                                        </Fields>
                                                                    </asp:DataPager>
                                                                </td>
                                                    ...
                                                    <EditItemTemplate>
                                                        <td runat="server" style="">
                                                            id_cargo:
                                                            <asp:Label ID="id_cargoLabel1" runat="server" Text='<%# Eval("id_cargo") %>' />
                                                            <br />
                                                            cargo:
                                                            <asp:TextBox ID="cargoTextBox" runat="server" Text='<%# Bind("cargo") %>' />
                                                            <br />
                                                    ...
                                                    <SelectedItemTemplate>
                                                        <td runat="server" style="">
                                                            id_cargo:
                                                            <asp:Label ID="id_cargoLabel" runat="server" Text='<%# Eval("id_cargo") %>' />
                                                            <br />
                                                            cargo:
