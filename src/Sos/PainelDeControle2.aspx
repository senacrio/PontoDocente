<%@ Page Language="VB" EnableEventValidation="false" AutoEventWireup="false" CodeFile="PainelDeControle.aspx.vb" Inherits="Sos_PainelDeControle" %>
...
<head runat="server">
    ...
    <link href="../clickoportunidades/Styles.css" rel="stylesheet" 
        type="text/css" />
</head>
<body>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:Button ID="Button2" runat="server" CausesValidation="False" 
                                                    ...
                                                    Enabled='<%# Bind("HabilitaResolver") %>' onclick="Button2_Click" 
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:Image ID="Image3" runat="server" Height="50px" 
                                                    ImageUrl="~/Imagens/velocimetro/velocimetro1.png" Width="50px" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                            ...
                                            <table class="style1">
                                                ...
                                                <tr>
                                                    <td class="style17">
                                                        &nbsp;</td>
                                                    <td>
                                                        <asp:GridView ID="grdArquivosAcp" runat="server" AutoGenerateColumns="False" 
                                                            DataKeyNames="IDArquivo" DataSourceID="sdsAnexosACP" ShowHeader="False">
                                                            <Columns>
                                                        ...
                                                        <asp:SqlDataSource ID="sdsAnexosACP" runat="server" 
                                                            ConnectionString="<%$ ConnectionStrings:SistemaSOS %>" 
                                                            InsertCommand="INSERT INTO sosArquivo(Descricao, Arquivo) VALUES (@Descricao, @Arquivo)" 
