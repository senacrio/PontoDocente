<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProcessoSelecaoAprovacao.aspx.vb" Inherits="ProcessoSelecaoAprovacao" %>
    ...
    <div>
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server" 
            EnableScriptGlobalization="True">
                ...
                <asp:Label ID="lblTitulo" runat="server" Text="APROVAR INSCRITOS" 
                    ...
                    <tr>
                        <td valign="top" width="64%">
                            <asp:GridView ID="gvwCandidatos" runat="server" AutoGenerateColumns="False" 
                                CaptionAlign="Left" DataKeyNames="IDInscricao" 
...
"></asp:SqlDataSource>
            ...
            <asp:View ID="VieAnalisarDados" runat="server">
                ...
                <asp:GridView ID="gdvAnaliseDados" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="IDTurma" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="RendaPercapita" ItemStyle-HorizontalAlign="Center" 
                            HeaderText="Renda Per Capita" SortExpression="RendaBrutaPessoal" 
                            DataFormatString="{0:c}" >
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
